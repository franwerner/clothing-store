...
const products: Array<ProductProps> = [
    ...
    { id: 10, name: "pantalones de chándalasdasdasdsdasdasdasd123 asdasd  asdasd asdasd", discount: 30, url: "https://http2.mlstatic.com/D_NQ_NP_896061-MLA79282533984_092024-O.webp", price: 30000.00, stock: false },
...
const ProductsContainer = () => {
    ...
    return (
        <div id="product-container" className="flex flex-col flex-1">
